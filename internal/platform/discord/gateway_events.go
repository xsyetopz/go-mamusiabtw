...
func (b *Bot) onGuildMemberJoin(e *events.GuildMemberJoin) {
	...
	if b.pluginAuto != nil {
		b.pluginAuto.FireEvent(pluginEventMemberJoin, pluginhost.Payload{
...
func (b *Bot) onGuildMemberLeave(e *events.GuildMemberLeave) {
	...
	if b.pluginAuto != nil {
		b.pluginAuto.FireEvent(pluginEventMemberLeave, pluginhost.Payload{
			GuildID:   snowflake.ID(guildID).String(),
			ChannelID: "",
			UserID:    user.ID.String(),
			Locale:    "",
...
func (b *Bot) onGuildBan(e *events.GuildBan) {
	...
	if b.pluginAuto != nil {
		b.pluginAuto.FireEvent(pluginEventGuildBan, pluginhost.Payload{
...
func (b *Bot) onGuildUnban(e *events.GuildUnban) {
	...
	if b.pluginAuto != nil {
		b.pluginAuto.FireEvent(pluginEventGuildUnban, pluginhost.Payload{
			GuildID:   e.GuildID.String(),
			ChannelID: "",
			UserID:    e.User.ID.String(),
			Locale:    "",
