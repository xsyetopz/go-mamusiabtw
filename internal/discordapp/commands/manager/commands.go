...
func slowmode() core.SlashCommand {
	return core.SlashCommand{
		Name:          "slowmode",
...
func slowmodeCreateCommand(locales []string, t core.Translator) discord.ApplicationCommandCreate {
...
func nickCreateCommand(locales []string, t core.Translator) discord.ApplicationCommandCreate {
	minLen, maxLen := 1, 32
...
func purgeCreateCommand(locales []string, t core.Translator) discord.ApplicationCommandCreate {
	const (
		purgeMinAll   = 2
		purgeMinCount = 1
		purgeMaxCount = 100
...
func purgeSubAll(t core.Translator, loc purgeLocalizer, minAll, maxAll int) discord.ApplicationCommandOptionSubCommand {
...
func purgeOptionMessage(t core.Translator, loc purgeLocalizer) discord.ApplicationCommandOptionString {
	maxLen := 255
...
func purgeExecute(_ context.Context, e *events.ApplicationCommandInteractionCreate, t core.Translator) error {
	const (
		purgeDefaultCount = 2
		purgeMinCount     = 1
		purgeMaxCount     = 100
...
func purgeUpdateError(e *events.ApplicationCommandInteractionCreate, t core.Translator) error {
	return (interactions.SlashUpdateInteractionResponse{Update: discord.MessageUpdate{
		Embeds: &[]discord.Embed{{
