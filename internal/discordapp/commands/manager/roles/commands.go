...
import (
	...
	"github.com/xsyetopz/go-mamusiabtw/internal/discordapp/commands/shared"
...
func Commands() []core.SlashCommand {
	return []core.SlashCommand{roles()}
}

func roles() core.SlashCommand {
...
func rolesCreateCommand(locales []string, t core.Translator) discord.ApplicationCommandCreate {
...
func rolesSubDelete(t core.Translator, loc rolesLocalizer) discord.ApplicationCommandOptionSubCommand {
	return discord.ApplicationCommandOptionSubCommand{
		Name:                     "delete",
...
func rolesSubAdd(t core.Translator, loc rolesLocalizer) discord.ApplicationCommandOptionSubCommand {
	return discord.ApplicationCommandOptionSubCommand{
		Name:                     "add",
...
func rolesSubRemove(t core.Translator, loc rolesLocalizer) discord.ApplicationCommandOptionSubCommand {
	return discord.ApplicationCommandOptionSubCommand{
		Name:                     "remove",
...
func rolesExecute(e *events.ApplicationCommandInteractionCreate, t core.Translator) error {
	guildID := e.GuildID()
	if guildID == nil {
