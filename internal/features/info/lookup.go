...
func lookup() commandapi.SlashCommand {
...
func lookupCreateCommand(locales []string, t commandapi.Translator) discord.ApplicationCommandCreate {
...
func lookupUser(ctx context.Context, e *events.ApplicationCommandInteractionCreate, t commandapi.Translator) error {
	_ = ctx
...
func buildUserLookupEmbed(full *discord.User, member *discord.Member, t commandapi.Translator) discord.Embed {
...
func userLookupFields(full *discord.User, member *discord.Member, t commandapi.Translator) []discord.EmbedField {
	inlineTrue := true
...
func lookupGuild(_ context.Context, e *events.ApplicationCommandInteractionCreate, t commandapi.Translator) error {
	guildID := e.GuildID()
	if guildID == nil {
		return (interactions.SlashMessage{
...
func lookupRole(e *events.ApplicationCommandInteractionCreate, t commandapi.Translator) error {
	guildID := e.GuildID()
	if guildID == nil {
		return (interactions.SlashMessage{
			Create: discord.NewMessageCreate().WithEphemeral(true).WithContent(t.S("err.not_in_guild", nil)),
...
func lookupChannel(e *events.ApplicationCommandInteractionCreate, t commandapi.Translator) error {
	guildID := e.GuildID()
	if guildID == nil {
		return (interactions.SlashMessage{
			Create: discord.NewMessageCreate().WithEphemeral(true).WithContent(t.S("err.not_in_guild", nil)),
...
func localize(locales []string, t commandapi.Translator, id string) map[discord.Locale]string {
