...
func Commands() []commandapi.SlashCommand { return []commandapi.SlashCommand{emojis()} }

func emojis() commandapi.SlashCommand {
...
func emojisCreateCommand(locales []string, t commandapi.Translator) discord.ApplicationCommandCreate {
...
func emojisExecute(ctx context.Context, e *events.ApplicationCommandInteractionCreate, t commandapi.Translator) error {
	guildID := e.GuildID()
	if guildID == nil {
