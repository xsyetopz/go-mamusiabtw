...
func Commands() []commandapi.SlashCommand { return []commandapi.SlashCommand{stickers()} }

func stickers() commandapi.SlashCommand {
...
func stickersCreateCommand(locales []string, t commandapi.Translator) discord.ApplicationCommandCreate {
...
func stickersExecute(ctx context.Context, e *events.ApplicationCommandInteractionCreate, t commandapi.Translator) error {
	guildID := e.GuildID()
	if guildID == nil {
