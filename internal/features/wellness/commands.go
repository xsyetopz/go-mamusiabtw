...
func timezone() commandapi.SlashCommand {
	return commandapi.SlashCommand{
		Name:          "timezone",
...
func timezoneCreateCommand(locales []string, t commandapi.Translator) discord.ApplicationCommandCreate {
...
func checkin() commandapi.SlashCommand {
	return commandapi.SlashCommand{
		Name:          "checkin",
...
func checkinCreateCommand(locales []string, t commandapi.Translator) discord.ApplicationCommandCreate {
	loc := func(id string) map[discord.Locale]string {
		return commandapi.LocalizeMap(locales, func(locale string) string {
			return t.Registry.MustLocalize(i18n.Config{Locale: locale, MessageID: id})
		})
...
func remind() commandapi.SlashCommand {
	return commandapi.SlashCommand{
		Name:          "remind",
...
func remindCreateCommand(locales []string, t commandapi.Translator) discord.ApplicationCommandCreate {
	loc := func(id string) map[discord.Locale]string {
		return commandapi.LocalizeMap(locales, func(locale string) string {
			return t.Registry.MustLocalize(i18n.Config{Locale: locale, MessageID: id})
		})
...
func mustUserLocation(ctx context.Context, st commandapi.Store, userID uint64) *time.Location {
