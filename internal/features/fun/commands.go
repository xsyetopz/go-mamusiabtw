...
func flip() commandapi.SlashCommand {
	return commandapi.SlashCommand{
		Name:   "flip",
...
func roll() commandapi.SlashCommand {
	return commandapi.SlashCommand{
		Name:          "roll",
...
func rollCreateCommand(locales []string, t commandapi.Translator) discord.ApplicationCommandCreate {
	const (
		rollMinNumber   = 1
		rollMaxNumber   = 99
		rollMinSides    = 4
...
func eightBall() commandapi.SlashCommand {
	return commandapi.SlashCommand{
		Name:   "8ball",
...
func hug() commandapi.SlashCommand {
...
func pat() commandapi.SlashCommand {
	return kawaiiUserCommand(
		"pat",
		"cmd.pat.name",
		"cmd.pat.desc",
...
func poke() commandapi.SlashCommand {
	return kawaiiUserCommand(
		"poke",
		"cmd.poke.name",
		"cmd.poke.desc",
...
func kawaiiUserCommand(name, nameID, descID, optNameID, optDescID string, endpoint kawaii.Endpoint) commandapi.SlashCommand {
	return commandapi.SlashCommand{
		Name:   name,
		NameID: nameID,
		DescID: descID,
		...
		Handle: func(ctx context.Context, _ *events.ApplicationCommandInteractionCreate, t commandapi.Translator, s commandapi.Services) (interactions.SlashAction, error) {
...
func shrug() commandapi.SlashCommand {
	return commandapi.SlashCommand{
		Name:   "shrug",
